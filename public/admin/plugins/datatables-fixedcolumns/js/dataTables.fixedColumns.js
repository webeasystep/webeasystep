...
var FixedColumns = function ( dt, init ) {
	...
	/**
	 * AdminSettings object which contains customisable information for FixedColumns instance
	 * @namespace
	...
	this.s = {
		...
		/**
		 * Is the document admin_layout right-to-left
		 * @type boolean
		 */
...
$.extend( FixedColumns.prototype , {
	 ...
	 *      var fc = new $.fn.dataTable.fixedColumns( table );
	 *
	 *      // Resize the table container and then have FixedColumns adjust its admin_layout....
	 *      $('#content').width( 1200 );
	 *      fc.fnRedrawLayout();
	 */
	...
	"_fnConstruct": function ( oInit )
	{
		...
		/* Set up the DOM that we want for the fixed column admin_layout grid */
		this._fnColCalc();
		this._fnGridSetup();
	...
	/**
	 * Calculate the column widths for the grid admin_layout
	 *  @returns {void}
	 *  @private
	 */
	"_fnColCalc": function ()
	...
	/**
	 * Set up the DOM for the fixed column. The way the admin_layout works is to create a 1x3 grid
	...
	/**
	 * Style and position the grid used for the FixedColumns admin_layout
	 *  @returns {void}
	 *  @private
	 */
	...
	/**
	 * Make a copy of the admin_layout object for a header or footer element from DataTables. Note that
	 * this method will clone the nodes in the admin_layout object.
	 *  @returns {Array} Copy of the admin_layout array
	...
	"_fnClone": function ( oClone, oGrid, aiColumns, bAll )
	{
		...
		if ( bAll )
		{
			...
			/* Copy the DataTables admin_layout cache for the header for our floating column */
		...
		else
		{
			 ...
			 * cloned cells, just copy the classes across. To get the matching admin_layout for the
