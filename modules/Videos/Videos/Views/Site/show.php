...
<main>
    <div class="container">
        <p class="video_details_path">
            <img src="<?= base_url() ?>site/imgs/li_arrow-right.png" />
                    ...
                    <ul>
                        <?php if (!empty($video_features)) {
                            foreach ($video_features as $feature): ?>
                                <li>
                                    <img src="<?= base_url('site/imgs/true.png') ?>" alt="Feature Icon" />
        ...
        <!--Video-->
        <section>
            <iframe src="<?= $video['youtube_link'] ?>" style="width:100%;height:500px" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
        </section>
        <!--Video-->
...
<script>
    ...
    $('#video_details_banner').owlCarousel({
        margin: 0,
        navText: ['<img src="<?= base_url('site/imgs/li_arrow-left.png') ?>"></img>', '<img src="<?= base_url('site/img/li_arrow-right.png') ?>"></img>'],
        nav: true,
        loop: true,
        dots: true,
