...
<div class="container-fluid">
    <div class="row">
        <div class="col-sm-6">
            <a href="<?= ADMIN_URL . 'videos/add' ?>" class="btn btn-primary mb-1 add">
    ...
    <?= $this->include('Modules\Videos\Views\Admin\show'); ?>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('.off_mode').on("click", function (e) {
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo site_url(ADMIN_URL . '/videos/bulk_merchant_off_mode');?>",
                data: {off_mode},
                dataType: "json",
