            ...
            foreach ($enrollments as $enrollment): ?>
                <div class="col-lg-6 mb-4" data-aos="fade-up">
                    <div class="media-h d-flex h-100">
                        <figure>
                            <img src="<?= thumb($enrollment->image,170,249) ?>" alt="Image">
                        </figure>
                        <div class="media-h-body">
                            <h2 class="mb-3"><a href="#"><?= $enrollment->title_ar ?></a></h2>
                            <div class="meta">
                                <span class="icon-calendar mr-2"></span><span><?= date('F d, Y', strtotime($enrollment->created_at)) ?></span>
                                <span class="icon-person mr-2"></span>msarlink.com
                            </div>
                            <p><?= $enrollment->desc_ar ?></p>
                        </div>
                    </div>
                </div>
            <?php endforeach; ?>
