...
<body>
    <div class="email-container">
        ...
        <div class="email-body">
            <h1 class="title">طلب اشتراك جديد في الموقع</h1>

            <p class="email-text">
                تم تسجيل طلب اشتراك جديد ويحتاج إلى مراجعة الإدارة.
            </p>

            <div class="details-box">
                <p><strong>اسم العميل:</strong> <?= esc($full_name) ?></p>
                <p><strong>البريد الإلكتروني:</strong> <?= esc($customer_email) ?></p>
            ...
            <div class="action-button-container">
                <a href="<?= esc($review_url) ?>" class="action-button">مراجعة الطلب الآن</a>
            </div>
        </div>

        <div class="email-footer">
            <p style="margin: 5px 0;">© <?= date('Y') ?> WebEasyStep. جميع الحقوق محفوظة.</p>
            <p style="margin: 5px 0;">هذا إشعار تلقائي من نظام الاشتراكات.</p>
        </div>
    </div>
</body>
</html>
