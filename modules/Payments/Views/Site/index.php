            ...
            foreach ($payments as $payment): ?>
                <div class="col-lg-6 mb-4" data-aos="fade-up">
                    <div class="media-h d-flex h-100">
                        <figure>
                            <img src="<?= thumb($payment->image,170,249) ?>" alt="Image">
                        </figure>
                        <div class="media-h-body">
                            <h2 class="mb-3"><a href="#"><?= $payment->title_ar ?></a></h2>
                            <div class="meta">
                                <span class="icon-calendar mr-2"></span><span><?= date('F d, Y', strtotime($payment->created_at)) ?></span>
