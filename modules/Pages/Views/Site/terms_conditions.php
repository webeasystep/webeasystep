            ...
            <div class="col-lg-6">
                <div class="consumer-section-card">
                    ...
                    <ol class="consumer-list-number">
                        ...
                        <li>الحساب شخصي ومخصص لطالب واحد فقط، ويُحظر مشاركة بيانات الدخول مع أي شخص آخر حفاظاً على جودة التجربة وحقوق المحتوى.</li>
                        <li><strong>تقييد الأجهزة:</strong> يُستخدم الحساب على جهاز حاسوب واحد فقط ضمن نظام حماية المحتوى. وإذا احتجت إلى تغيير الجهاز أو واجهت مشكلة تقنية بعد إعادة التهيئة، يمكنك التواصل مع الدعم الفني لإعادة التفعيل وفق الضوابط المعتمدة وبآلية واضحة وميسّرة.</li>
                    </ol>
                </div>
            </div>
            <div class="col-lg-6">
        ...
        <div class="row consumer-grid-row">
            ...
            <div class="col-lg-6">
                <div class="consumer-section-card">
                    ...
                    <ol class="consumer-list-number">
                        <li><strong>الضمان الذهبي:</strong> إذا شعرت في أي وقت خلال أول <strong>30 يوماً</strong> من الاشتراك أن الشرح لا يعالج فجوة التعليم الذاتي لديك، فيحق لك طلب استرداد اشتراكك بالكامل.</li>
                        <li>يتم التعامل مع طلبات الاسترداد خلال مدة الضمان الذهبي بشكل مباشر وواضح، دون تعقيد غير مبرر.</li>
                        <li>لا يسري هذا الضمان في حال مخالفة الشروط الأساسية للاستخدام أو إساءة استخدام الحساب أو المحتوى.</li>
                    </ol>
                </div>
            </div>
        </div>
