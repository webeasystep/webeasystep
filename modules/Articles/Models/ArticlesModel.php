...
class ArticlesModel extends BaseModel
{
    ...
    protected $allowedFields = ['title', 'slug', 'meta_description', 'meta_tags', 'content', 'image', 'sort', 'active'];
    ...
    public function detailCustomer($id = null)
    {
        ...
        $builder = $this->builder($this->table)->select('id, title, slug, meta_description, meta_tags, content, image, sort, active');
        if (empty($id)) {
