                                                    ...
                                                    <?php foreach ($unit->items as $item) : ?>
                                                        <li>
                                                            ...
                                                            <?php if ($isPreview): ?>
                                                                ...
                                                                <a href="#" class="preview-video-link" data-video-id="<?= esc($item->item_id) ?>" data-library-id="<?= esc($metadata['video_library_id'] ?? '495222') ?>">
                                                            ...
                                                            if ($item->item_type === 'video' && $duration): ?>
    ...
    document.addEventListener("DOMContentLoaded", function () {
        ...
        previewLinks.forEach(link => {
            link.addEventListener("click", function (event) {
                ...
                let libraryId = this.getAttribute("data-library-id") || '495222';
                if (videoId) {
                    // Construct the MediaDelivery embed URL
                    let videoUrl = `https://iframe.mediadelivery.net/embed/${libraryId}/${videoId}?autoplay=true`;
