...
defined('ADMIN_URL') || define('ADMIN_URL',$base_url.'dt_admin/');

defined('ADMIN_PREFIX') || define('ADMIN_PREFIX','dt_admin/');

defined('ADMIN_PATH') || define('ADMIN_PATH', ROOTPATH . 'public\admin');

defined('SITE_PATH') || define('SITE_PATH', ROOTPATH . 'public\site');
...
defined('ORDER_ACCEPT') or define('ORDER_ACCEPTED', 2); // highest automatically-assigned error code
defined('ORDER_TAKEN') or define('ORDER_TAKEN', 3); // highest automatically-assigned error code
defined('ORDER_CANCEL') or define('ORDER_CANCELED', 4); // highest automatically-assigned error code
