...
$routes->get('activate-account', [\Modules\Users\Controllers\Users::class, 'activateAccount']);
...
$routes->group('site', ['namespace' => 'App\Controllers'], function ($routes) {
    $routes->match(['GET', 'POST'], 'logout', [\Modules\Users\Controllers\Users::class, 'logout']);
    $routes->match(['GET', 'POST'], 'forget_password', [\Modules\Users\Controllers\Users::class, 'ForgotPassword']);
    $routes->match(['GET', 'POST'], 'reset_password', [\Modules\Users\Controllers\Users::class, 'ResetPassword']);
    ...
    $routes->get('post-login-redirect', [\Modules\Users\Controllers\Users::class, 'handlePostLoginRedirect'], ['filter' => 'site_filter']);
