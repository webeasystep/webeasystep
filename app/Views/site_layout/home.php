                    ...
                    <div class="row justify-content-center ">
                        <div class="col-lg-8 text-center ">
                            ...
                            <h1 class="mb-4 heading text-white" data-aos="fade-up" data-aos-delay="100">
                                النجاح في SEU ليس أصعب... بل يحتاج للطريقة الصحيحة.
                            </h1>

                            <p class="mb-4 text-white" style="font-size: 1.1rem; line-height: 1.6;" data-aos="fade-up" data-aos-delay="200">
                                منصة تعليمية متخصصة لطلاب <strong>الجامعة السعودية الإلكترونية</strong>، تجمع كل ما تحتاجه للتفوق الأكاديمي في مكان واحد.
                            </p>
            ...
            <div class="row">
                <div class="col-6 col-md-4 mb-4" data-aos="fade-up" data-aos-delay="100">
                    <div class="feature text-center">
                        ...
                        <p>دعم مباشر طوال العام عبر تيليجرام للإجابة على استفساراتك.. وداعاً لعجز "التعلم الذاتي" بمفردك.</p>
                    </div>
                </div>
                ...
                <div class="col-6 col-md-4 mb-4" data-aos="fade-up" data-aos-delay="300">
                    <div class="feature text-center">
                        ...
                        <p>تعلّم بلسان المهندس، لا بلسان الملقن. ننقل لك خبرة 12 عاماً، مع إرشادات مهنية لتصميم الـ CV ومعسكرات تدريبية صيفية.</p>
                    </div>
                </div>
            </div>
        </div>
