<head>
    ...
    <link rel="preload" href="<?= base_url() ?>site/css/style_rtl.css?v=2.06" as="style" onload="this.onload=null;this.rel='stylesheet'">
    <noscript><link rel="stylesheet" href="<?= base_url() ?>site/css/style_rtl.css?v=2.06"></noscript>

    <link rel="stylesheet" href="<?= base_url() ?>site/css/dark-mode-overrides.css?v=1.4">
